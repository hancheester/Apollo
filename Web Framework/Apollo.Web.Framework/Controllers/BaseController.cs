...
namespace Apollo.Web.Framework.Controllers
{
    public abstract class BaseController : Controller
    {
        ...
        /// <param name="model">Model</param>
        /// <returns>Result</returns>
        public virtual string RenderPartialViewToString(string viewName, object model, string htmlFieldPrefix = null)
        {
        ...
        {
            //TODO: Need to implement DefaultLogger from Apollo
            //if (logException)
