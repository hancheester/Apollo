...
namespace Apollo.Web.Framework.Services.Common
{
    public static class GenericAttributeExtensions
    {
        public static TPropType GetAttribute<TPropType>(this BaseEntity entity, string keyGroup, string key, int storeId = 0)
        {
            var utilityService = EngineContext.Current.Resolve<IUtilityService>();
            return GetAttribute<TPropType>(entity, keyGroup, key, utilityService, storeId);
        }
