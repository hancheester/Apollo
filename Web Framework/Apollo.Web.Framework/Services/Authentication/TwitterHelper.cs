...
namespace Apollo.Web.Framework.Services.Authentication
{
    ...
    {
        public static TwitterLogin GetTwitterLogin(string oauth_token, string oauth_token_secret, string oauth_consumer_key, string oauth_consumer_secret)
        {
            ...
            return JsonConvert.DeserializeObject<TwitterLogin>(new StreamReader(response.GetResponseStream()).ReadToEnd());
        }
    }
