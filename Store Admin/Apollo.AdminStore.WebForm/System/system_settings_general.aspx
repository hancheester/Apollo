<%@ Page Language="C#" MasterPageFile="~/Inspinia.Master" AutoEventWireup="true" CodeBehind="system_settings_general.aspx.cs" Inherits="Apollo.AdminStore.WebForm.System.system_settings_general" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-striped">
                    <tr>
                        <th>Saved bulk product file path</th>
                        <td><asp:TextBox ID="txtBulkProductFileLocalPath" runat="server" CssClass="form-control" TextMode="MultiLine" Height="100px"></asp:TextBox></td>
                    </tr>
                 </table>
