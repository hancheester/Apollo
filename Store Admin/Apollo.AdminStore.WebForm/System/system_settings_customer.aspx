<%@ Page Language="C#" MasterPageFile="~/Inspinia.Master" AutoEventWireup="true" CodeBehind="system_settings_customer.aspx.cs" Inherits="Apollo.AdminStore.WebForm.System.system_settings_customer" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-striped">
                    <tr>
                        <th>Allow viewing of customer profiles</th>
                        <td><asp:CheckBox ID="cbAllowViewingProfiles" runat="server" /></td>
                    </tr>
                 </table>
