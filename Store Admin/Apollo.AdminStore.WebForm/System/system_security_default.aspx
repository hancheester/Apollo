<%@ Page Language="C#" MasterPageFile="~/Inspinia.Master" AutoEventWireup="true" CodeBehind="system_security_default.aspx.cs" Inherits="Apollo.AdminStore.WebForm.System.system_security_default" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-striped">
                    <tr>
                        <th>Secret key</th>
                        <td><asp:TextBox ID="txtSecretKey" runat="server" CssClass="form-control"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th>IV key</th>
                        <td><asp:TextBox ID="txtIVKey" runat="server" CssClass="form-control"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <th>Disable SSL</th>
                        <td><asp:CheckBox ID="cbDisableSSL" runat="server" /></td>
                    </tr>
                 </table>
