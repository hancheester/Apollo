<%@ Page Language="C#" MasterPageFile="~/Inspinia.master" AutoEventWireup="True" Inherits="Apollo.AdminStore.WebForm.Sales.refund_info" Codebehind="refund_info.aspx.cs" ValidateRequest="false" %>
...
<asp:Content ContentPlaceHolderID="primaryPlaceHolder" runat="server">
    ...
    <Apollo:OrderNav runat="server" Type="Refund" />
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                <div class="panel-body">
                                    <Apollo:OrderInfo ID="eoiView" NewCommentAreaVisible="false" CommentAreaVisible="true" SummaryAreaVisible="false" runat="server" />
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <asp:LinkButton ID="lbConfirm" ValidationGroup="vgRefund" runat="server" CssClass="btn btn-primary" Text="Confirm Refund" OnClick="lbConfirm_Click"></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
