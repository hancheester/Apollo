<%@ Page Language="C#" MasterPageFile="~/Inspinia.master" AutoEventWireup="true" Inherits="Apollo.AdminStore.WebForm.Sales.order_refund_new" Codebehind="order_refund_new.aspx.cs" ValidateRequest="false" %>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-6">
                                        <asp:LinkButton ID="lbSubmit" ValidationGroup="vgRefund" runat="server" CssClass="btn btn-primary" Text="Schedule Refund" OnClick="lbSubmit_Click"></asp:LinkButton> 
                                    </div>
                                </div>
                            </div>
                        </div>
