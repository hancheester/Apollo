<%@ Page Language="C#" MasterPageFile="~/Inspinia.master" AutoEventWireup="true" Inherits="Apollo.AdminStore.WebForm.Sales.refund_default" Codebehind="refund_default.aspx.cs" %>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="table-responsive">
                            ...
                            <Apollo:CustomGrid ID="gvRefunds" runat="server" PageSize="10" AllowPaging="true" AllowSorting="true" OnPageIndexChanging="gvRefunds_PageIndexChanging" ShowHeaderWhenEmpty="true"
                                AutoGenerateColumns="false" OnSorting="gvRefunds_Sorting" OnPreRender="gvRefunds_PreRender" ShowHeader="true" CssClass="table table-striped table-bordered table-hover dataTable">
                                ...
                                <PagerTemplate>            
                                    <asp:Panel runat="server" DefaultButton="btnRefundGoPage">
                                        ...
                                        of <%= gvRefunds.PageCount%> pages |
                                        <asp:PlaceHolder ID="phRecordFound" runat="server">Total <%= gvRefunds.RecordCount %> records found</asp:PlaceHolder>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount To Refund" HeaderStyle-Width="100" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate><%# AdminStoreUtility.GetFormattedPrice((decimal)Eval("ValueToRefund"), Eval("CurrencyCode").ToString(), CurrencyType.HtmlEntity) %></ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Date" SortExpression="DateStamp" HeaderStyle-Width="160">
                                        <HeaderTemplate>
                                            <asp:LinkButton CommandArgument="DateStamp" runat="server" CommandName="Sort">Date</asp:LinkButton>
                                            <br />
                                            <asp:TextBox ID="txtFromDate" runat="server" CssClass="date form-control" />
                                            to
                                            <asp:TextBox ID="txtToDate" CssClass="date form-control" runat="server" />
                                        </HeaderTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Action" HeaderStyle-Width="100">
                                        <ItemTemplate>
                                            <a href='<%# "/sales/refund_info.aspx?refundinfoid=" + Eval("Id") + "&orderid=" + Eval("OrderId") %>'>View</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </Apollo:CustomGrid>
