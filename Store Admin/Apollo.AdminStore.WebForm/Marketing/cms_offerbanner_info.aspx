<%@ Page Language="C#" MasterPageFile="~/Inspinia.master" AutoEventWireup="true" Inherits="Apollo.AdminStore.WebForm.Marketing.cms_offerbanner_info" Codebehind="cms_offerbanner_info.aspx.cs" %>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-12">
                ...
                <asp:ValidationSummary ID="vsBannerSum" runat="server" DisplayMode="BulletList" ValidationGroup="vgEditBanner" CssClass="valSummary alert alert-warning" />
                <table class="table table-striped">
                    ...
                    <tr>
                        <th>Media banner<small class="text-navy clearfix">(size should be 790x220)</small></th>
                ...
                <div class="col-lg-12">
                    ...
                    <asp:LinkButton ID="lbSaveContinue" runat="server" Text="Update" ValidationGroup="vgEditBanner" OnClick="lbSaveContinue_Click" CssClass="btn btn-sm btn-primary"></asp:LinkButton>
                    <asp:LinkButton ID="lbDelete" runat="server" Text="Delete" OnClick="lbDelete_Click" OnClientClick="return confirm('Are you sure to delete this banner?');" CssClass="btn btn-sm btn-warning"></asp:LinkButton>                    
                </div>
            </div>
        </div>
    </div>
