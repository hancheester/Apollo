<%@ Page Language="C#" MasterPageFile="~/Inspinia.master" AutoEventWireup="true" Inherits="Apollo.AdminStore.WebForm.Marketing.promo_cart_offer_default" Codebehind="promo_cart_offer_default.aspx.cs" %>
                        ...
                        <div class="table-responsive">
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="html5buttons">
                                    <div class="dt-buttons btn-group">
                                        <asp:LinkButton ID="lbCleanBasket" runat="server" Text="Clean basket" OnClientClick="return confirm('Are you sure to remove all items related to any offers from customers basket?');" OnClick="lbCleanBasket_Click" CssClass="btn btn-default buttons-copy buttons-html5"></asp:LinkButton>
                                        <a href="/marketing/promo_cart_offer_new.aspx" class="btn btn-default buttons-copy buttons-html5">Create</a>
                                        ...
                                        <a href="/marketing/promo_cart_offer_default.aspx" class="btn btn-default buttons-copy buttons-html5">Refresh</a>
                            ...
                            <asp:Panel ID="pnlOfferGrid" runat="server" DefaultButton="lbSearch">            
                                <Apollo:CustomGrid ID="gvRules" runat="server" PageSize="10" AllowPaging="true" AllowSorting="true" OnPageIndexChanging="gvRules_PageIndexChanging" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="ID" SortExpression="Id" HeaderStyle-Width="100">                
                                            <HeaderTemplate>                                
                                        ...
                                        <asp:TemplateField HeaderText="Promo Code" SortExpression="PromoCode" HeaderStyle-Width="150">
                                            <HeaderTemplate>
                                                <asp:LinkButton CommandArgument="PromoCode" runat="server" CommandName="Sort">Promo Code</asp:LinkButton><br />
                                                <asp:TextBox ID="txtPromoCode" runat="server" CssClass="form-control"></asp:TextBox>
                                            </HeaderTemplate>
                                            <ItemTemplate><%# Eval("PromoCode")%></ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                <a href='<%# "/marketing/promo_cart_offer_info.aspx?offerruleid=" + Eval("Id") %>'>Edit</a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>          
                                </Apollo:CustomGrid>
