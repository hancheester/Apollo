<%@ Page Language="C#" MasterPageFile="~/Inspinia.Master" AutoEventWireup="true" CodeBehind="cms_blog_post_info.aspx.cs" ValidateRequest="false" Inherits="Apollo.AdminStore.WebForm.Marketing.cms_blog_post_info" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="pull-right">
                    ...
                    <asp:LinkButton ID="lbDelete" runat="server" Text="Delete" OnClick="lbDelete_Click" CssClass="btn btn-sm btn-danger"></asp:LinkButton>
                </div>
            </div> 
        </div>
    </div>
                                ...
                                <div class="panel-body">
                                    <table class="table" style="margin-bottom: 0;">
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:CheckBox ID="cbAllowComments" runat="server" /></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="panel-body">
                                    <table class="table" style="margin-bottom: 0;">
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="txtMetaDescription" TextMode="MultiLine" Height="150px" runat="server" CssClass="form-control"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <th>Meta title</th>
