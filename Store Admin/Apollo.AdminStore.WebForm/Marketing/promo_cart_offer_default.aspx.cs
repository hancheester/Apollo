...
{
    public partial class promo_cart_offer_default : BasePage
    {
        ...
        protected void lbResetFilter_Click(object sender, EventArgs e)
        {
            ...
            DisposeState(PROMO_CODE_FILTER);
        ...
        protected void lbSearch_Click(object sender, EventArgs e)
        {
            ...
            SetState(PROMO_CODE_FILTER, ((TextBox)gvRules.HeaderRow.FindControl("txtPromoCode")).Text.Trim());
        ...
        {
            int gotoIndex = Convert.ToInt32(((TextBox)gvRules.TopPagerRow.FindControl("txtPageIndex")).Text.Trim()) - 1;
