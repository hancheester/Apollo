...
namespace Apollo.Dache.Client
{
    ...
    internal class CommunicationClient : ICacheHostContract
    {
        ...
        public bool IsSet(string cacheKey)
        {
            ...
            return SendIsSet(cacheKey);
        }

        public IDictionary<string, string> GetPerformanceData()
        {
            return SendGetPerformanceData();
        }
        ...
        private void SendRemoveByPattern(string pattern)
        {
            byte[] command = null;

            var sb = new StringBuilder();
            sb.Append("delbypattern");
            sb.Append(" ").Append(pattern);
        ...
        private void SendRemoveCacheStartsWith(string key)
        {
            byte[] command = null;

            var sb = new StringBuilder();
            sb.Append("delstartwith");
