using Apollo.Core.ComponentModel;
...
namespace Apollo.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        private static bool _createPluginsDirectoryOnStartup;
        ...
        public static void Initialize()
        {
            ...
            {
                // TODO: Add verbose exception handling / raising here since this is happening on app startup and could prevent app from starting altogether
                ...
                _createPluginsDirectoryOnStartup = !string.IsNullOrEmpty(ConfigurationManager.AppSettings["CreatePluginsDirectoryOnStartup"]) &&
                   Convert.ToBoolean(ConfigurationManager.AppSettings["CreatePluginsDirectoryOnStartup"]);
                ...
                try
                {
                    ...
                    if (_createPluginsDirectoryOnStartup)
                    {
                        ...
                        foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                        {
                            ...
                            if (!pluginDescriptor.SupportedVersions.Contains(ApolloVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                            {
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            if (plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name +
                                                    " file exists in a folder outside of the allowed mail application folder hierarchy");
